...
## streamlit-to-sigma (scaffolded — fill in)

TODO: map this skill's local phase numbers to C1–C10 (and add it as a
column to the mapping table above). Generated by tools/new-skill.rb.
