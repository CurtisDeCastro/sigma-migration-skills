...
#                       tokens: 120_000)   # tokens optional
...
#
# Record shape (one JSON line per call, append-only):
#   {"phase":"discover","wall_s":61.7,"tokens":120000,"at":"2026-07-27T00:00:00Z"}
...
module PhaseMetrics
  ...
  def record(workdir:, phase:, wall_s:, tokens: nil, at: nil)
