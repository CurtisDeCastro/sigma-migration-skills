...
> Inventory a folder of Alteryx Designer workflows (.yxmd) and produce a migration-readiness readout — tool mix, dbt-offramp density, and a value/cost-ranked shortlist. File-based and read-only; no Alteryx Server/Gallery write, no Sigma write.
