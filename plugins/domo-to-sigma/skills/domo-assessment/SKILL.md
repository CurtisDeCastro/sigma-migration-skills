...
description: Inventory a Domo instance and produce a migration-readiness readout — environment counts, content mix, complexity, and a value/cost-ranked shortlist. Read-only.
---

# Domo migration assessment (read-only)
