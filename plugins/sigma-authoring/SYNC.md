...
- **Vendored at:** sigma-skills `feat/openapi-spec-update-2026-08` @ `d6379de9b75dda8a77ff3f8bfaa3e61da8306853` (not yet merged to `main`; re-vendor from `main` once that PR merges — plain fast-forward, not a re-vendor)
