...
- **Converting an Alteryx workflow (.yxmd)** → `alteryx-to-sigma` in sigma-migration-skills. Local converter (`converter/cli.mjs`); never a hosted MCP. ETL Sigma should not fake is a dbt/warehouse offramp.
