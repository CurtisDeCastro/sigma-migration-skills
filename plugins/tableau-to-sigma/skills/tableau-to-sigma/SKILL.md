...
| 6 | **🚧 Parity + visual** | `phase6-parity.rb`; then `assert-dashboard-read.rb` + `assert-phase6-ran.rb` | 🚧 `parity-final.json` PASS + recorded visual verdict | `refs/phase-6-parity.md` |
